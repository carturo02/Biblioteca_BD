...
public class SanctionManager extends JDialog {
	...
	private RoundJButton getRndjbtnInsertBook() {
		if (rndjbtnInsertBook == null) {
			...
			rndjbtnInsertBook.setText("DELETE SANCTION");
	...
	private RoundJButton getRndjbtnUpdateBook() {
		if (rndjbtnUpdateBook == null) {
			...
			rndjbtnUpdateBook.setText("UPDATE SANCTION");
	...
	private JTable getTable() {
		if (table == null) {
			...
			table.setModel(new DefaultTableModel(
				...
				new String[] {
					"DNI User", "Name User", "Type", "Date Start", "Date Expired"
				}
			));
	...
	private JLabel getLblNewLabel_1_1() {
		if (lblNewLabel_1_1 == null) {
			lblNewLabel_1_1 = new JLabel("SANCTION LIST");
	...
	private JRadioButton getRdbtnNewRadioButton() {
		if (rdbtnNewRadioButton == null) {
			rdbtnNewRadioButton = new JRadioButton("Only Expired Date");
